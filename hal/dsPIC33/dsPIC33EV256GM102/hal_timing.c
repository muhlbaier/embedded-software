 ...
 * @file hal_timing.c
 * 
 * @addtogroup hal_timing_dspic33ev256gm102 HAL Timing Module for dsPIC33EV256GM102
 * @ingroup timing
 * 
...
#define TIMING_INT_NUM 0
#elif TIMING_NUMBER == 4
#define TIMING_IP IPC6bits.T4IP
#define TIMING_INT_NUM 1
#elif TIMING_NUMBER == 5
#define TIMING_IP IPC7bits.T5IP
#define TIMING_INT_NUM 1
#else
