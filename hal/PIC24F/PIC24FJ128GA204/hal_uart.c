...
#define Set_U2Tx_PPS(pin) CAT5(RPOR, OUTPUT_PIN_TO_REG_NUM(pin), bits.RP, pin, R) = 5 // U2TX
#define Set_U3Tx_PPS(pin) CAT5(RPOR, OUTPUT_PIN_TO_REG_NUM(pin), bits.RP, pin, R) = 19 // U3TX
#define Set_U4Tx_PPS(pin) CAT5(RPOR, OUTPUT_PIN_TO_REG_NUM(pin), bits.RP, pin, R) = 21 // U4TX
