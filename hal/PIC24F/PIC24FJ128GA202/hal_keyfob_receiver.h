 ...
 * @author Michael Muhlbaier
  * 
  * @todo Add macros to allow other IC moduels besides IC1 and IC2 from being used
 * @{
 */

/** Override default bit times to avoid conversion to us each time
 * 
 * HAL is setup to count in microseconds when FCPU is 16000000
 */
#ifndef KEYFOB_MIN_TIME_UNIT
#define KEYFOB_MIN_TIME_UNIT ((280 * FCPU) / 16000000)
#endif

#ifndef KEYFOB_MAX_TIME_UNIT
#define KEYFOB_MAX_TIME_UNIT ((520 * FCPU) / 16000000)
#endif
