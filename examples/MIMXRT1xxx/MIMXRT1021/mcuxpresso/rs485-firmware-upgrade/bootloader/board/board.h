...
#define RAM_END_ADDRESS         0x20010000
#define FLASH_APP_SIZE          0x0003C000
#define ADC0_MUX_SIZE_V4        (14)
#define BOOTLOADER_SIZE			0x00010000

//#define FLASH_BOOTLOADER_START  FSL_FEATURE_FLASH_PFLASH_START_ADDRESS
#define FLASH_BOOTLOADER_START 		0x60002400
#define FLASH_APP_START 			0x60100000
#define FLASH_APP_END   (FLASH_APP_START + FLASH_APP_SIZE)
//#define FLASH_END       (FSL_FEATURE_FLASH_PFLASH_START_ADDRESS + FSL_FEATURE_FLASH_PFLASH_BLOCK_SIZE)
#define FLASH_END       (FLASH_BOOTLOADER_START + 4*1024*1024)

#define FLASH_APP_JUMP_ADDR			((FLASH_APP_START) + 0x00003000)
