...
// NOTE:
//------------------------------------------------------------------------------
// Bootloader is required for this example to run as application is sitting at
// 0x60100000 address
//
//
//wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww

void runEepromTEST(void);
void runNvmTEST(void);
...
int main(void)
{
	...
	initSYSTIM();
	initDEBUG("APP1", '4', "Main app v1.0 MIMXRT1021 Hal Test");
	...
	//uint32_t * ptr = (uint32_t *)0x60100000;
	debugMAIN(0, "system ready %xb...\n",c_fw_metadata[0]);
